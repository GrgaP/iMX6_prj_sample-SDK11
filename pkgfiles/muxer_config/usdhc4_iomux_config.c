...
void usdhc4_iomux_config(void)
{
    ...
    // HW_IOMUXC_USDHC4_CARD_CLK_IN_SELECT_INPUT_WR(0x00000000);
    // Mux Register:
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: NAND_READY_ALT8
    ...
    // Config usdhc4.SD4_RESET to pad NAND_ALE(A16)
    // HW_IOMUXC_SW_MUX_CTL_PAD_NAND_ALE_WR(0x00000001);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_NAND_ALE_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_NAND_ALE_MUX_MODE_V(ALT1));
    // Pad Control Register:
