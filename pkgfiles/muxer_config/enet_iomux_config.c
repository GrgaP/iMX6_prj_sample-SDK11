...
void enet_iomux_config(void)
{
    ...
    // Config enet.ENET_TX_EN to pad ENET_TX_EN(V21)
    // HW_IOMUXC_SW_MUX_CTL_PAD_ENET_TX_EN_WR(0x00000001);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_ENET_TX_EN_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_ENET_TX_EN_MUX_MODE_V(ALT1));
    // Pad Control Register:
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: ENET_RX_DATA0_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_DATA0_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_DATA0_SELECT_INPUT_DAISY_V(ENET_RX_DATA0_ALT1));
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: ENET_RX_DATA1_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_DATA1_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_DATA1_SELECT_INPUT_DAISY_V(ENET_RX_DATA1_ALT1));
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: KEY_COL2_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_DATA2_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_DATA2_SELECT_INPUT_DAISY_V(KEY_COL2_ALT1));
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: KEY_COL0_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_DATA3_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_DATA3_SELECT_INPUT_DAISY_V(KEY_COL0_ALT1));
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: GPIO18_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_CLK_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_CLK_SELECT_INPUT_DAISY_V(GPIO18_ALT1));
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: ENET_CRS_DV_ALT1
    //               Selecting Pads Involved in Daisy Chain.
    ...
    HW_IOMUXC_ENET_MAC0_RX_EN_SELECT_INPUT_WR(
            BF_IOMUXC_ENET_MAC0_RX_EN_SELECT_INPUT_DAISY_V(ENET_CRS_DV_ALT1));
