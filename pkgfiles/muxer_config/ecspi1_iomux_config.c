...
void ecspi1_iomux_config(void)
{
    ...
    //   DAISY [1:0] - Input Select (DAISY) Field Reset: CSI0_DATA06_ALT2
    ...
    //   DAISY [1:0] - Input Select (DAISY) Field Reset: CSI0_DATA05_ALT2
    //                 Selecting Pads Involved in Daisy Chain.
    ...
    //   DAISY [1:0] - Input Select (DAISY) Field Reset: CSI0_DATA04_ALT2
    //                 Selecting Pads Involved in Daisy Chain.
    ...
    // Config ecspi1.ECSPI1_SS0 to pad DISP0_DATA23(W24)
    // HW_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA23_WR(0x00000002);
    ...
    HW_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA23_WR(
            ...
            BF_IOMUXC_SW_MUX_CTL_PAD_DISP0_DATA23_MUX_MODE_V(ALT2));
    // Pad Control Register:
    ...
    // Input Select Register:
    // IOMUXC_ECSPI1_SS0_SELECT_INPUT(0x020E07E4)
    //   DAISY [1:0] - Input Select (DAISY) Field Reset: CSI0_DATA07_ALT2
    //                 Selecting Pads Involved in Daisy Chain.
    //     CSI0_DATA07_ALT2 (0) - Select signal ecspi1 ECSPI1_SS0 as input from pad CSI0_DATA07(ALT2).
    //     DISP0_DATA23_ALT2 (1) - Select signal ecspi1 ECSPI1_SS0 as input from pad DISP0_DATA23(ALT2).
    //     EIM_EB2_ALT1 (2) - Select signal ecspi1 ECSPI1_SS0 as input from pad EIM_EB2(ALT1).
    //     KEY_ROW1_ALT0 (3) - Select signal ecspi1 ECSPI1_SS0 as input from pad KEY_ROW1(ALT0).
    HW_IOMUXC_ECSPI1_SS0_SELECT_INPUT_WR(
            BF_IOMUXC_ECSPI1_SS0_SELECT_INPUT_DAISY_V(CSI0_DATA07_ALT2));
}
