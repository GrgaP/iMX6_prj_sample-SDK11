...
void i2c1_iomux_config(void)
{
    ...
    // HW_IOMUXC_SW_MUX_CTL_PAD_CSI0_DATA09_WR(0x00000004);
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: CSI0_DATA09_ALT4
    ...
    // HW_IOMUXC_SW_MUX_CTL_PAD_CSI0_DATA08_WR(0x00000004);
    ...
    //   DAISY [0] - Input Select (DAISY) Field Reset: CSI0_DATA08_ALT4
    //               Selecting Pads Involved in Daisy Chain.
